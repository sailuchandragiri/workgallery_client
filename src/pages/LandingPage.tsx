    ...
    <div className="bg-[#040102] pt-12 text-white font-gilroy text-center md:text-left">
      ...
      >
        ...
        <div className="flex justify-center ...">
          <div className="flex justify-between gap-4 rounded-xl md:rounded-2xl mt-8 md:mt-14 text-sm md:text-lg font-normal bg-btnbackground py-3 px-10 md:py-5 md:px-16 ... w-[350px] md:w-[500px]">
            <div>Feasible</div>
            <div>|</div>
            <div>Scalable</div>
            <div>|</div>
        ...
        <div className="flex gap-3 flex-col justify-center ...">
          ...
          <div className="mt-10 flex flex-col gap-8  ...">
            <div className="flex flex-col justify-center gap-4">
              ...
              <div className="font-normal text-xs text-pf_subtitle">
      ...
      <footer className="hidden md:block bg-[#131313] py-16 px-32 font-gilroy">
        <div className="flex flex-col gap-6 justify-center ...">
          ...
          <div className="flex justify-center gap-10 leading-2 text-sm text-base font-normal text-footer_font ...">
            <div>Blogs</div>
            <div>About Us</div>
            <div>Contact Us</div>
            <div>Careers</div>
          ...
          <div className="text-sm text-center font-normal text-base text-footer_font">
            Copyright Text
          </div>
        </div>
      </footer>
      ...
      <footer className="block md:hidden bg-[#131313] py-12 px-10 font-gilroy">
        <div className="flex flex-col gap-6 justify-center ...">
          ...
          <div className="flex justify-center flex-col gap-6 leading-2 text-sm text-base text-footer_font ...">
            <div>Blogs</div>
            <div>About Us</div>
            <div>Contact Us</div>
            <div>Careers</div>
          ...
          <div className="text-sm text-center text-base text-footer_font">Copyright Text</div>
        </div>
      </footer>
    </div>
  );
